...
export const ExamForm = forwardRef<{ getSnapshot: () => any }, Props>(
  function ExamForm({ onToast }, ref) {
    const {
      setValue,
      validate,
      getSnapshot,
    ...
    const onChange = (name: string, value: string) => {
      const v =
        name === "subject" ? value.replace(/\s+/g, " ").trimStart() : value;
            ...
            {steps.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  borderBottom:
                    step === i ? "2px solid #3B38A0" : "2px solid #eee",
                  padding: "4px 12px",
                  transition: "all 0.2s",
                  fontSize: 15,
                }}
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onChange("multipleChoice", e.target.value)
                      }
                    />
                  </div>
                  <div
          ...
          {step === 2 && (
            <>
              <div className="form-group">
                ...
                />
                {errors.timeMinutes && (
                  <small className="error">{errors.timeMinutes}</small>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  name="reference"
                  rows={3}
                  placeholder="... (preguntar sobre subir archivos o de donde poner sacar referencia)"
                  className="input-hover"
